...
def refine_business_names(industry, additional_names):
    refine_prompt = f"Carefully examine the following list of words and phrases related to the {industry} industry: {', '.join(additional_names)}. Your task is to rigorously filter the list, ensuring that only words with a direct, exclusive, and unambiguous connection to the {industry} industry are retained. Exclude words that, while they may appear in business names within the industry, do not have a clear and unique association with the industry itself. For example, general terms like 'Solutions', 'Services', 'Systems' or geographical names should be removed. Compile a new list that includes only words with a clear, unique, and strict relevance to the {industry} industry, and ensure to omit all function words like 'all', 'the', 'mr', 'dr', 'pty', 'ltd', etc."
