...
def refine_business_names(industry, additional_names):
    refine_prompt = f"Please conduct a thorough analysis of the following list of words and phrases associated with the {industry} industry: {', '.join(additional_names)}. Your task is to carefully examine the list and remove any words or phrases that do not have a direct, exclusive, and unambiguous connection to the {industry} industry. Exclude words or phrases that, although they may appear in business names within the industry, do not possess a clear and distinctive association with the industry itself. For example, eliminate general terms like 'Solutions', 'Services', 'Systems', as well as geographical names. Create a new list that only includes words or phrases that have a clear, unique, and strict relevance to the {industry} industry. Additionally, ensure that all function words such as 'all', 'the', 'mr', 'dr', 'pty', 'ltd', etc., are excluded."
